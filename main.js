...
var _sliderPattern = __webpack_require__(0);

document.onreadystatechange = function () {
  if (document.readyState === 'complete') {

    // init Slider pattern with optional parent selector (defaults to whole document scope)
    (0, _sliderPattern.sliderInit)('.container');
    //
    // examples below ways teams may interact with pattern:
    //
    //
  }
};
